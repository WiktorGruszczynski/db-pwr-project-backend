...
from app.auth.service import get_password_hash, verify_password, generate_session_id, get_session_expiration
from app.database import get_db_connection  # Import z Twojego pliku database.py
...
def get_my_profile(current_user: dict = Depends(get_current_user)):
    # To się wykona TYLKO wtedy, gdy get_current_user nie rzuci błędem
    return {
        "message": "Witaj w tajnej strefie!", 
